...
public class TickPerfectGiantsFoundryOverlay2d extends OverlayPanel {
    private static final int REGION_ID = 13491;
    private final Client client;
    private final TickPerfectGiantsFoundryPlugin plugin;
    private final TickPerfectGiantsFoundryState state;
    private final TickPerfectGiantsFoundryConfig config;

	@Inject
	private TickPerfectGiantsFoundryOverlay2d(
            Client client,
            TickPerfectGiantsFoundryPlugin plugin,
